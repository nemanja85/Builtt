      ...
      <div className="px-6 mx-auto max-w-7xl lg:px-8">
        <div className="max-w-2xl md:max-w-7xl">
          ...
          <div className="flex flex-col justify-between md:flex-row">
            ...
            <div className="w-full p-4 mt-5 space-y-3 max-h-96 bg-ligth-gray md:w-1/ md:mt-0 md:ml-8 md:max-w-[300px] lg:max-w-[400px]">
              ...
              <div className="flex flex-col w-full space-y-3">
                <div>
                  ...
                  <div className="flex flex-row justify-between">
                    ...
                    <p className="text-lg leading-[25px] font-normal">
                      -{discount} <sup className="pl-1 text-xs">RSD</sup>
                    </p>
                  </div>
